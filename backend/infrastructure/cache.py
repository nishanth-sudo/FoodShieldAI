...
class CacheService:
    ...
    async def set(self, key: str, value: Any, ttl: int = 300) -> bool:  # noqa: ANN401
    ...
    async def get_by_image_hash(self, image_hash: str) -> Any | None:  # noqa: ANN401
        return await self.get(f'img_hash:{image_hash}')

    async def set_image_hash_result(self, image_hash: str, result: dict, ttl: int = 3600) -> None:
