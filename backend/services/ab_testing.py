...
class ABTestingService:
    ...
    def get_active_test(self) -> ABTest | None:
        for test in self.tests.values():
            if test.is_active:
                return test
        return None

    def assign_variant(self, user_id: str) -> ABTestVariant | None:
    ...
    def record_result(self, test_id: str, variant_id: str, success: bool) -> None:
