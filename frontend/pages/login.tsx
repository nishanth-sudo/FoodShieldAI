...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-12 px-4 sm:px-0 animate-fadeIn">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700 rounded-xl p-6 space-y-5">
        <div>
      ...
      <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
        {t.noAccount}{" "}
        <Link href="/register" className="font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded px-1">
          {t.register}
        </Link>
      </p>
    </div>
